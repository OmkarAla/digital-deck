...
export default function BrandFitSimulator() {
      ...
      <div className="relative z-10 max-w-[1700px] w-full mx-auto flex flex-col xl:flex-row items-center justify-between gap-16 h-full">
        ...
        <div className="text-left w-full xl:w-[45%] flex-shrink-0 py-10">
          <div className="flex items-center justify-start gap-4 mb-10 overflow-hidden">
             ...
             <span className="text-dubai-gold uppercase tracking-[0.6em] text-xs font-black">Strategic Ecosystem Mapping</span>
          </div>
          <h3 className="text-6xl md:text-8xl font-black uppercase tracking-[-0.06em] leading-[0.85] mb-10">
            OPTIMIZE YOUR <br /> <span className="text-white/20 italic font-medium">LEGACY.</span>
          </h3>
          <p className="text-white/40 text-2xl font-light tracking-tight max-w-lg leading-relaxed">
             Identify the precise commercial node that aligns with your brand's heritage and velocity.
          </p>
        </div>

        {/* Right Side: Interactive Panel */}
        <div className="glass-panel p-12 lg:p-16 w-full xl:w-[55%] h-[75vh] flex flex-col justify-between border border-white/5 relative overflow-hidden">
                    ...
                    {step === 2 && (
                      <div className="grid grid-cols-1 gap-4 w-full">
                        {investments.map((inv) => (
                          ...
                          >
                            <inv.icon className={cn("transition-colors duration-500", selections.investment === inv.id ? "text-dubai-gold" : "text-white/20")} size={32} />
                            <div>
          ...
          {isAnalyzing && (
             <div className="flex-1 flex flex-col items-center justify-center text-center gap-8 h-full">
                <div className="relative">
                  ...
                  >
                     <Target size={24} className="text-dubai-gold" />
                  </motion.div>
                </div>
                <div className="space-y-4">
                  <h4 className="text-2xl font-black uppercase tracking-[0.3em] text-white">Aggregating Nodes</h4>
                  <p className="text-white/20 text-[10px] uppercase tracking-[0.4em] font-bold">Correlating Demographics & Velocity</p>
                </div>
             </div>
          )}
               ...
               <div className="flex flex-col xl:flex-row gap-12 items-stretch h-full">
                  <div className="flex-1 flex flex-col justify-center">
                     <div className="flex items-center gap-3 mb-8">
                        ...
                        <span className="text-dubai-gold uppercase tracking-[0.4em] text-[10px] font-black">ID: 0094-DM</span>
                     </div>
                     
                     <h5 className="text-4xl md:text-6xl font-black uppercase mb-6 tracking-[-0.05em] leading-[0.9]">
                     ...
                     <p className="text-white/40 leading-relaxed font-light text-lg mb-10 tracking-tight">
                        Based on targeting for {selections.objective}, this is the highest-velocity zone within the {selections.category} cluster.
                     </p>
                  ...
                  <div className="w-full xl:w-1/3 min-h-[250px] xl:min-h-0 relative overflow-hidden flex-shrink-0 border border-white/5 rounded-sm">
                     ...
                     <div className="absolute bottom-6 left-6 right-6">
                        <div className="text-dubai-gold font-black text-[9px] uppercase tracking-[0.4em] mb-2">Spatial Preview</div>
